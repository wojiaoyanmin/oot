...
class SOLOHead(nn.Module):
    ...
    def get_seg(self, cate_preds, kernel_preds, human_cate_pred,
             human_kernel_pred,seg_pred,human_seg_pred, img_metas, cfg, rescale=None):
        ...
        for img_id in range(len(img_metas)):
            ...
            human_seg_pred_list = human_seg_pred[img_id, ...].unsqueeze(0)
            kernel_pred_list = [
            ...
            result,_ = self.get_seg_single(cate_pred_list, kernel_pred_list,seg_pred_list,
                                        human_seg_pred_list, human_cate, human_kernel,
    ...
    def get_seg_single(self,
        ...
        human_ins_preds = human_ins_preds.reshape(N,-1)
        
        human_seg_preds = torch.matmul(human_kernel_preds,human_ins_preds).reshape(I,H,W).sigmoid()
