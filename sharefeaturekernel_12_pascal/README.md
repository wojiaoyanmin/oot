...
./tools/dist_train.sh configs/ym/ym_r101_fpn_1x_CIHP.py 1
./tools/dist_test.sh configs/solo/solo_r50_fpn_1x_CIHP.py work_dirs/solo_r50_fpn_1x_CIHP/latest.pth 2 --eval segm  --show --show-dir work_dirs/insvis  --show-score-thr 0.3 --options "outfile_prefix=./work_dirs/json"

./tools/dist_test.sh configs/ssis/ssis_r50_fpn_1x_cityscapes.py work_dirs/5_nocoor/epoch_6.pth 4 --eval segm  --options "outfile_prefix=./work_dirs/5_nocoor/jsonvis/"

./tools/dist_test.sh configs/ssis/ssis_r50_fpn_1x_cityscapes.py work_dirs/5_nocoor/epoch_6.pth 4 --eval segm --show2 --options "outfile_prefix=./work_dirs/5_nocoor/jsonvis/5"

tensorboard --logdir=tf_logs
./tools/dist_train.sh configs/ym/ym_r101_fpn_1x_CIHP.py 2 --options "classwise=True"

./tools/dist_train.sh configs/solo/solo_r50_fpn_1x_CIHP.py 2 --resume-from ./work_dirs/solo_r50_fpn_1x_CIHP/latest.pth
